   ...
   public DataContext(DbContextOptions<DataContext> options) : base(options)
   {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        .HasKey(x => new {x.AlunoId,x.DisciplinaId});
         ...
         var professor = builder.Entity<Professor>();
         professor.HasKey(x=> x.Id);
         professor.Property(x=> x.Id).ValueGeneratedOnAdd();
         ...
         disciplina.HasKey(x=> x.Id);
         disciplina.Property(x=> x.Id).ValueGeneratedOnAdd();
         ...
         var aluno = builder.Entity<Aluno>();
         aluno.HasKey(x=> x.Id);
         aluno.Property(x=> x.Id).ValueGeneratedOnAdd();
